...
async function visualizaDadosGlobais(){
    ...
    paragrafo.innerHTML = `O mundo tem <span>${totalPessoasMundo} bilhoẽs</span> de habitantes, 
    dos quais <span>${totalPessoasConectadas} bilhoẽs</span> estão conectados em alguma rede social 
    por um tempo médio de <span>${tempoMedio} horas</span>.`;
